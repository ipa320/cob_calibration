...
success_amount = 5 # 														Amount of succeeded detections needed for completion
fail_amount = 50 # 															Amount of failed detections needed before giving up
...
class Listener():
	...
	def run(self):
		...
		if resolution <= 200: # Image becomes too large for viewing when resolution is above 200.
			print "Select the image window and press a key to recalculate calibration object pose\n"
